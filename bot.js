...
client.channels.get("737044545094811689").send(cagatay);
});
client.on("message", message => {
  ...
  client.channels.get("737044370322096259").send(dmlog);
  }
});
client.on("message", async msg => {
  ...
  const i = await db.fetch(`ssaass_${msg.guild.id}`);
    ...
    client.on("guildCreate", guild => {
      ...
      kanal.send(
      " <a:boost:740517288553218072> Beni Sunucuna Eklediğin İçin Teşekkürler Komutları Öğrenmek İçin <a:nitro2:740518407673217084> c!yardım <a:elmas:740517295138275368> Destek Sunucum İçin <a:pin:740517295935455242> c!davet Yazman Yeterli."
      );
      });
//--------------------------------GEÇİCİ KANAL----------------------------//
...
client.on("message", async message => {
  ...
  if (command === "özelodasistemi") {
    ...
    message.channel.send(
      `Özel Oda Sisteminin Kurulmasını İstiyorsanız **Kur** Yazınız.`
    );
    message.channel
      .awaitMessages(response => response.content === "Kur", {
        max: 1,
        time: 10000,
        errors: ["time"]
      })
      .then(collected => {
        ...
        message.guild
          .createChannel(`➕│2 Kişilik Oda`, "voice")
          .then(channel =>
            channel.setParent(
              message.guild.channels.find(
                channel => channel.name === "【🔐】2 Kişilik Odalar【🔐】"
              )
            )
          );
        ...
        message.guild
          .createChannel(`➕│3 Kişilik Oda`, "voice")
          .then(channel =>
            channel.setParent(
              message.guild.channels.find(
                channel => channel.name === "【🔐】3 Kişilik Odalar【🔐】"
              )
            )
          );
        ...
        message.guild
          .createChannel(`➕│4 Kişilik Oda`, "voice")
          .then(channel =>
            channel.setParent(
              message.guild.channels.find(
                channel => channel.name === "【🔐】4 Kişilik Odalar【🔐】"
              )
            )
          );
        ...
        message.guild
          .createChannel(`➕│5 Kişilik Oda`, "voice")
          .then(channel =>
            channel.setParent(
              message.guild.channels.find(
                channel => channel.name === "【🔐】5 Kişilik Odalar【🔐】"
              )
            )
          );
...
client.on('ready', () => {
 client.user.setActivity(`${client.guilds.size} Sunucu + ${client.users.size} Kullanıcı! c!davet`);
})
